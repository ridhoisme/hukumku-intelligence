...
import { GeneralListCaseCustomProps } from "../../../../../type/general";
...
export default function TableCasesColumns() {
  ...
  const columns: TableColumnsType<GeneralListCaseCustomProps> = [
    {
      title: () => (
    ...
    {
      title: () => (
        <TableHead noWrapTitle className="w-[150px]" title="Nama Hakim" />
      ),
      dataIndex: "judge",
      key: "judge",
      render: (val, rec) => (
